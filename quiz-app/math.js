...
function loadMathQuestion() {
  const questionContainer = document.getElementById("math-question-container");
...
function displayResult() {
  ...
  resultDiv.textContent = `Your total score is ${score} out of ${mathQuestions.length}.`;
  resultDiv.classList.remove("hidden");
  document.getElementById("math-question-container").classList.add("hidden");
  document.getElementById("next-button").classList.add("hidden");
}
